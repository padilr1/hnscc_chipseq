...
Cutoff: Log2FC > 2 & normalized mean counts > 400; 308 genes for NSD1KO.c1 and 123 genes for NSD1KO.c17
```{r,echo=FALSE,message=FALSE,warning=FALSE,fig.show="hold", out.width="100%",fig.align='center'}
...
Cutoff: Log2FC < -2 & normalized mean counts > 400; 233 genes for NSD1KO.C1 and 212 genes for NSD1KO.C17
```{r,echo=FALSE,message=FALSE,warning=FALSE,fig.show="hold", out.width="100%",fig.align='center'}
